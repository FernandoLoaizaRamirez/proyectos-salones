    ...
    <main className="min-h-screen">
      ...
      <footer className="border-t border-border">
        <div className="mx-auto max-w-6xl px-6 py-8 text-xs text-muted-foreground">
          {evento.lugar} · Demo de {evento.organizador.nombre}. En esta demostración el acomodo se
          guarda en este dispositivo (se actualiza en vivo entre pestañas del mismo navegador) y se
          comparte por enlace o QR; para editarlo entre varios organizadores a la vez se conecta a un
          sistema central.
        </div>
      </footer>
    </main>
