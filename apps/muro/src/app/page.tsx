    ...
    <main className="min-h-screen">
      ...
      <footer className="border-t border-border">
        <div className="mx-auto max-w-6xl px-6 py-8 text-xs text-muted-foreground">
          {evento.lugar} · Demo de {evento.organizador.nombre}. En esta demostración los mensajes se
          guardan en este dispositivo (se actualizan en vivo entre pestañas del mismo navegador);
          para reunir en una sola pantalla los mensajes de todos los teléfonos a la vez se conecta a
          un sistema central.
        </div>
      </footer>
    </main>
